...
cc.Class({
    ...
    onLoad: function () {
        this.sitEdit = this.node.getChildByName("sitDown").getChildByName("sitEdit").getComponent("cc.EditBox");
    ...
    loadLater:function(){
        ...
        if(this.bankerMode == 8)
        {
            ...
            this.betBtnBox.getChildByName("bet4").getChildByName("Label").getComponent("cc.Label").string = 4;
            this.betBtnBox.getChildByName("bet5").getChildByName("Label").getComponent("cc.Label").string = 5;
            this.betNumMax = 5;
            this.niuniuBetType = [0,1,2,3,4,5];
        }else{
            this.betBtnBox.getChildByName("bet1").getChildByName("Label").getComponent("cc.Label").string = 1;
            ...
            this.betBtnBox.getChildByName("bet4").getChildByName("Label").getComponent("cc.Label").string = 15;
            this.betBtnBox.getChildByName("bet5").getChildByName("Label").getComponent("cc.Label").string = 20;
            this.betNumMax = 20;
            this.niuniuBetType = [0,1,5,10,15,20];
        }
    ...
    onBtnBetClicked:function(event, customEventData){
        ...
        var curBetNum = this.niuniuBetType[betType];
        var self = this;
        pomelo.clientSend("bet",{"bet": curBetNum},function(){
            if(self.bankerMode != 7)
    ...
    btnSitDown:function(){
        console.log("sitDown chair === "+this.sitEdit.string);
        pomelo.request("connector.entryHandler.sendData", {"code":"sitDown","params":{chair:parseInt(this.sitEdit.string)}}, function(data) {
            console.log("sitDown @@@@@@@@");
            console.log(data);
        });
    },
    ...
    btnBankerStart:function(){
        pomelo.request("connector.entryHandler.sendData", {"code":"beginGame","params":{}}, function(data) {
            console.log("standUp @@@@@@@@");
            console.log(data);
        });
    },
