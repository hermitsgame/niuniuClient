...
cc.Class({
    ...
    onInit:function(){
        ...
        this.moveDistance1 = -200;
        this.moveBeginPos2 = -665;
        this.moveDistance2 = 300;
    ...
    cancelMove:function(){
        ...
        if(checkDis)
        {
            ...
            this.scheduleOnce(showCardFunc,1);
        }else{
    ...
    initCard:function(handCard){
        ...
        for(var i in handCard)
        {
            ...
            this.cardList[i].getComponent("cc.Sprite").spriteFrame = confige.cardFrameMap[curCardIndex];
        }
        ...
        if(this.curCardNum == 5)
        {
            ...
            this.cardList[0].x = -40;
            this.cardList[1].x = 40;

            this.cardList[2].y = this.moveBeginPos2;
            this.cardList[3].y = this.moveBeginPos2;
            this.cardList[4].y = this.moveBeginPos2;

            this.cardList[2].scale = 3;
            this.cardList[3].scale = 3;
            this.cardList[4].scale = 3;
            ...
            this.cardList[2].runAction(this.getAction(1));
            this.cardList[3].runAction(this.getAction(1));
            this.cardList[4].runAction(this.getAction(1));
        }
        if(this.curCardNum == 3)
        {
            ...
            this.cardList[0].scale = 3;
            this.cardList[1].scale = 3;
            this.cardList[2].scale = 3;
            this.cardList[0].rotation = 4;
            this.cardList[2].rotation = -4;
            this.cardList[0].runAction(this.getAction(1));
    ...
    btnShowCardClick:function(){
        ...
        this.scheduleOnce(showCardFunc,1.3);
    },
